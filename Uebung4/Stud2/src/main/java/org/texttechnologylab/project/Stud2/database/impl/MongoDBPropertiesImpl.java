 ...
 * @author Stud2
 */
public class MongoDBPropertiesImpl extends Properties implements org.texttechnologylab.project.Stud2.database.MongoDBProperties {
     ...
     */
    public MongoDBPropertiesImpl(String path) throws IOException {
        super();
