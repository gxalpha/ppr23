 ...
 * @author Stud2
 */
public class Wahlperiode_Impl extends BundestagObject_Impl implements Wahlperiode {
     ...
     */
    public Wahlperiode_Impl(String label, int number, Date startDate, Date endDate) {
        super(label);
        this.number = number;
